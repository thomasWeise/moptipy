...
static_analysis: init
	...
	ruff --target-version py310 --select A,ANN,B,C,C4,COM,D,DTZ,E,ERA,F,I,ICN,INP,N,PIE,PLC,PLE,PLR,PLW,Q,RET,RUF,S,SIM,T,T10,T20,TID,UP,W,YTT --ignore=ANN001,ANN002,ANN003,ANN101,ANN204,ANN401,B008,B009,B010,C901,D203,D208,D212,D401,D407,D413,N801,PLR0913,PLR2004,RUF100,UP035 --line-length 79 moptipy &&\
	ruff --target-version py310 --select A,ANN,B,C,C4,COM,D,DTZ,E,ERA,F,I,ICN,N,PIE,PLC,PLE,PLR,PLW,Q,RET,RUF,S,SIM,T10,TID,UP,W,YTT --ignore=ANN001,ANN002,ANN003,ANN101,ANN204,ANN401,B008,B009,B010,C901,D203,D208,D212,D401,D407,D413,N801,PLR0913,PLR2004,RUF100,UP035 --line-length 79 examples &&\
	ruff --target-version py310 --select A,ANN,B,C,C4,COM,D,DTZ,E,ERA,F,I,ICN,N,PIE,PLC,PLE,PLR,PLW,Q,RET,RUF,T,SIM,T10,T20,TID,UP,W,YTT --ignore=ANN001,ANN002,ANN003,ANN101,ANN204,ANN401,B008,B009,B010,C901,D203,D208,D212,D401,D407,D413,N801,PLR0913,PLR2004,RUF100,UP035 --line-length 79 tests &&\
