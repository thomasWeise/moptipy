...
static_analysis: init
	...
	ruff --select A,ANN,B,C,D,E,F,I,N,Q,RUF,S,T,U,YTT --ignore=ANN001,ANN002,ANN003,ANN101,ANN204,ANN401,B008,B009,B010,C901,D203,D208,D212,D407,D413,N801,RUF100 --line-length 79 moptipy &&\
	ruff --select A,ANN,B,C,D,E,F,I,N,Q,RUF,S,U,YTT --ignore=ANN001,ANN002,ANN003,ANN101,ANN204,ANN401,B008,B009,B010,C901,D203,D208,D212,D407,D413,N801,RUF100 --line-length 79 examples &&\
	ruff --select A,ANN,B,C,D,E,F,I,N,Q,RUF,T,U,YTT --ignore=ANN001,ANN002,ANN003,ANN101,ANN204,ANN401,B008,B009,B010,C901,D203,D208,D212,D407,D413,N801,RUF100 --line-length 79 tests &&\
