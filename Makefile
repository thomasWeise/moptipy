...
test: init
	...
	coverage run --include="moptipy*" -m pytest --strict-config tests -o faulthandler_timeout=720 --ignore=examples && \
	echo "$(NOW): Running pytest with doctests." && \
	coverage run --include="moptipy*" -a -m pytest --strict-config --doctest-modules -o faulthandler_timeout=360 --ignore=tests --ignore=examples && \
...
static_analysis: init
	...
	ruff --select A,ANN,B,C,D,E,F,I,N,Q,RUF,S,T,UP,YTT --ignore=ANN001,ANN002,ANN003,ANN101,ANN204,ANN401,B008,B009,B010,C901,D203,D208,D212,D407,D413,N801,RUF100 --line-length 79 moptipy &&\
	ruff --select A,ANN,B,C,D,E,F,I,N,Q,RUF,S,UP,YTT --ignore=ANN001,ANN002,ANN003,ANN101,ANN204,ANN401,B008,B009,B010,C901,D203,D208,D212,D407,D413,N801,RUF100 --line-length 79 examples &&\
	ruff --select A,ANN,B,C,D,E,F,I,N,Q,RUF,T,UP,YTT --ignore=ANN001,ANN002,ANN003,ANN101,ANN204,ANN401,B008,B009,B010,C901,D203,D208,D212,D407,D413,N801,RUF100 --line-length 79 tests &&\
