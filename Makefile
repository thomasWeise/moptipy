...
static_analysis: init
	...
	flake8 . --ignore=W503,TC003,TC101,DUO102 && \
	...
	ruff --select A,B,C,D,E,F,I,N,S,T,U --ignore=D212,D203,D413,D407,D208,N801,B008,B009,B010 --line-length 79 moptipy &&\
	ruff --select A,B,C,D,E,F,I,N,S,U --ignore=D212,D203,D413,D407,D208,N801,B008,B009,B010 --line-length 79 examples &&\
	ruff --select A,B,C,D,E,F,I,N,S,T,U --ignore=D212,D203,D413,D407,D208,N801,S101,B008,B009,B010 --line-length 79 tests &&\
