...
static_analysis: init
	...
	ruff --select A,ANN,B,C,C4,COM,D,DTZ,E,ERA,F,I,ICN,N,PIE,PLC,PLE,PLR,PLW,Q,RET,RUF,S,SIM,T,T10,T20,TID,UP,W,YTT --ignore=ANN001,ANN002,ANN003,ANN101,ANN204,ANN401,B008,B009,B010,C901,D203,D208,D212,D407,D413,N801,PLR2004,RUF100 --line-length 79 moptipy &&\
