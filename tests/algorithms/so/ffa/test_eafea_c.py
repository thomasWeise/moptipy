...
def test_eafeac_on_jssp() -> None:
    """Validate the EAFEA-C on the JSSP."""
...
def test_eafeac_on_onemax() -> None:
    """Validate the EAFEA-C on the OneMax problem."""
...
def test_eafeac_on_leadingones() -> None:
    """Validate the EAFEA-C on the LeadingOnes problem."""
...
def test_eafeac_on_leadingones_large_range() -> None:
    """Validate the EAFEA-C on the LeadingOnes problem with larger bounds."""
