...
def test_ppa_on_jssp_1_1() -> None:
    ...
    def create(instance: Instance, search_space: Permutations,
        ...
        return PPA(Op0Shuffle(search_space),
                   (Op1SwapExactlyN if (random.integers(2) <= 0)
                    else Op1SwapTryN)(search_space), 1, 1)

    validate_algorithm_on_jssp(create)


def test_ppa_on_jssp_2_2() -> None:
    """Validate the PPA on the JSSP."""
    ...
    def create(instance: Instance, search_space: Permutations,
        ...
        return PPA(Op0Shuffle(search_space),
                   (Op1SwapExactlyN if (random.integers(2) <= 0)
                    else Op1SwapTryN)(search_space), 2, 2)
...
def test_ppa_on_leadingones_random() -> None:
    """Validate the PPA on the LeadingOnes problem."""
